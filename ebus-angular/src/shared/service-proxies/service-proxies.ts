...
export class AuditLogServiceProxy {
     ...
     * @return Success
     */
    getPaged(startDate: moment.Moment | null | undefined, endDate: moment.Moment | null | undefined, filterText: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfAuditLogListDto> {
        let url_ = this.baseUrl + "/api/services/app/AuditLog/GetPaged?";
    ...
    protected processGetPaged(response: HttpResponseBase): Observable<PagedResultDtoOfAuditLogListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getById(id: number | null | undefined): Observable<AuditLogListDto> {
        let url_ = this.baseUrl + "/api/services/app/AuditLog/GetById?";
        if (id !== undefined)
    ...
    protected processGetById(response: HttpResponseBase): Observable<AuditLogListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getForEdit(id: number | null | undefined): Observable<GetAuditLogForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/AuditLog/GetForEdit?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GetAuditLogForEditOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetAuditLogForEditOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetForEdit(response: HttpResponseBase): Observable<GetAuditLogForEditOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetAuditLogForEditOutput.fromJS(resultData200) : new GetAuditLogForEditOutput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetAuditLogForEditOutput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrUpdate(input: CreateOrUpdateAuditLogInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/AuditLog/CreateOrUpdate";
        url_ = url_.replace(/[?&]$/, "");
    ...
    batchDelete(input: number[] | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/AuditLog/BatchDelete";
        url_ = url_.replace(/[?&]$/, "");
...
export class GetAuditLogForEditOutput implements IGetAuditLogForEditOutput {
    auditLog: AuditLogEditDto | undefined;

    constructor(data?: IGetAuditLogForEditOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.auditLog = data["auditLog"] ? AuditLogEditDto.fromJS(data["auditLog"]) : <any>undefined;
        }
    }

    static fromJS(data: any): GetAuditLogForEditOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetAuditLogForEditOutput();
        result.init(data);
        return result;
    }
    ...
    clone(): GetAuditLogForEditOutput {
        const json = this.toJSON();
        let result = new GetAuditLogForEditOutput();
        result.init(json);
        return result;
...
export interface IGetAuditLogForEditOutput {
    auditLog: AuditLogEditDto | undefined;
}

export class AuditLogEditDto implements IAuditLogEditDto {
    id: number | undefined;
    impersonatorUserId: number | undefined;
    exception: string | undefined;
    browserInfo: string | undefined;
    ...
    constructor(data?: IAuditLogEditDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AuditLogEditDto {
        data = typeof data === 'object' ? data : {};
        let result = new AuditLogEditDto();
        result.init(data);
        return result;
    }
...
export interface IAuditLogEditDto {
    id: number | undefined;
    impersonatorUserId: number | undefined;
    exception: string | undefined;
    browserInfo: string | undefined;
...
export class CreateOrUpdateAuditLogInput implements ICreateOrUpdateAuditLogInput {
    auditLog: AuditLogEditDto;

    constructor(data?: ICreateOrUpdateAuditLogInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (!data) {
            this.auditLog = new AuditLogEditDto();
        }
    }

    init(data?: any) {
        if (data) {
            this.auditLog = data["auditLog"] ? AuditLogEditDto.fromJS(data["auditLog"]) : new AuditLogEditDto();
        }
    }

    static fromJS(data: any): CreateOrUpdateAuditLogInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateOrUpdateAuditLogInput();
        result.init(data);
        return result;
    }
    ...
    clone(): CreateOrUpdateAuditLogInput {
        const json = this.toJSON();
        let result = new CreateOrUpdateAuditLogInput();
        result.init(json);
        return result;
...
export interface ICreateOrUpdateAuditLogInput {
    auditLog: AuditLogEditDto;
}
