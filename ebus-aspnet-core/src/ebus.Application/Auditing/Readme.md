...
复制以下代码到Application层下的：ebusApplicationModule.cs
...
如果你生成了**权限功能**。复制以下代码到 ebusApplicationModule.cs
中的 PreInitialize 方法中:
...
```
        ...
        {
            modelBuilder.ApplyConfiguration(new AuditLogCfg());
        }
...
<text name="ImpersonatorUserId"  value="ImpersonatorUserId"></text>
<text name="Exception"  value="Exception"></text>
<text name="BrowserInfo"  value="BrowserInfo"></text>
<text name="ClientName"  value="ClientName"></text>
<text name="ClientIpAddress"  value="ClientIpAddress"></text>
<text name="ExecutionDuration"  value="ExecutionDuration"></text>
<text name="ExecutionTime"  value="ExecutionTime"></text>
<text name="TenantId"  value="TenantId"></text>
<text name="MethodName"  value="MethodName"></text>
<text name="ServiceName"  value="ServiceName"></text>
<text name="UserId"  value="UserId"></text>
<text name="ImpersonatorTenantId"  value="ImpersonatorTenantId"></text>
<text name="Parameters"  value="Parameters"></text>
<text name="CustomData"  value="CustomData"></text>
